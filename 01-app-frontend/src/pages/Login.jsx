...
export default function Login({ onLogin, dataMode }) {
  ...
  const roles = [
    ...
    { email: 'analyst@cova.in', role: 'analyst', icon: '📊', name: 'Actuarial Analyst', desc: 'Power BI Executive Reporting — Loss ratios, GWP, fraud savings' },
    { email: 'admin@cova.in', role: 'admin', icon: '⚙️', name: 'ClaimCrypt Admin', desc: 'CDI weights, fraud rules, simulations, system health' },
    { email: 'qcommerce@cova.in', role: 'qcommerce', icon: '📦', name: 'Q-Commerce Platform', desc: 'Monitor active demand, zone fleet health, and disruptions' },
  ];
